...
if ($parser->attr('isSign')) {
    if ($parser->attr('showImgSign')) {
        return '<span class="f-bb-img-cont"><span class="f-bb-img-chk"></span><img src="' . $body . '" alt="' . $attrs['Def'] . '" loading="lazy" class="sigimage f-bbivert"></span>';
    }
} else {
    // тег в теле сообщения
    if ($parser->attr('showImg')) {
        return '<span class="f-bb-img-cont"><span class="f-bb-img-chk"></span><img src="' . $body . '" alt="' . $attrs['Def'] . '" loading="lazy" class="postimg f-bbivert"></span>';
    }
}
